(function ($) {
  $(document).ready(function() {
    ...
    window.index.add({
      href: 'http://materializecss.com/autocompleteInstance.html',
      title: 'Autocomplete',
      body: 'Add an autocompleteInstance dropdown below your input to suggest possible values in your form. You can populate the list of autocompleteInstance options dynamically as well.'
    });
